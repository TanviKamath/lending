...
It replaces the /apply half of `portal.build.public_pages`, and posts to the same guest
endpoints: send_mobile_code, confirm_mobile_code, submit_lead and create_account, none
of them changed.
