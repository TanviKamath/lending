...
The Builder page this replaces is `portal.build.overview_page`, and the two read the
same payload: `lending.portal.core.get_dashboard`, unchanged. What differs is what
